export const limitedCommand = [
  {
    ...
    options: [
      ...
      },
      {
        name: "noticias",
        description:
          "Recibe/remueve los pings de los canales de noticias de Wolfy.",
        type: 1,
      },
      {
        name: "eventos",
        description:
          "Recibe/remueve los pings de los canales de eventos del servidor.",
        type: 1,
      },
      {
        name: "alianzas",
        description:
          "Recibe/remueve los pings de los canales de alianzas del servidor.",
        type: 1,
      },
    ],
  },
